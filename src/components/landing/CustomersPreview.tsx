    ...
    <div className="w-full h-full bg-background flex flex-col text-[10px] sm:text-xs">
      <div className="h-8 border-b border-border/40 bg-muted/30 flex items-center px-4 justify-between shrink-0">
        <div className="flex items-center gap-2">
          <div className="h-3 w-16 bg-primary/20 rounded-full flex items-center px-2 text-[6px] text-primary font-bold">CUSTOMERS</div>
        </div>
      ...
      <div className="flex-1 p-4 space-y-4 overflow-hidden">
        <div className="flex justify-between items-center">
          ...
          <div className="h-6 px-3 bg-primary rounded-lg flex items-center text-[8px] text-primary-foreground font-bold">Add New</div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="h-7 w-full border border-border/50 rounded-lg bg-muted/20 flex items-center px-8 text-muted-foreground text-[8px]">
            Search by name, industry or risk level...
          </div>
        </div>
        ...
        <div className="border border-border/50 rounded-xl overflow-hidden bg-card">
          <div className="h-8 bg-muted/30 border-b border-border/40 flex items-center px-3 gap-4 text-[7px] font-bold text-muted-foreground uppercase tracking-wider">
            <div className="w-24">Company Name</div>
            <div className="w-16">Industry</div>
            <div className="w-12">Risk</div>
          </div>
        ...
        <Card className="rounded-xl border-primary/20 bg-primary/5 shadow-lg p-4 relative overflow-hidden">
          <div className="flex items-center gap-2 text-primary mb-2">
            ...
            <div className="text-[8px] font-bold uppercase tracking-widest">AI Smart Insight</div>
          </div>
          <div className="space-y-1">
            <p className="text-[9px] font-medium leading-tight">
              <span className="text-primary font-bold">Global Logistics Ltd</span> has shown a 40% decrease in platform activity this week.
            </p>
            <p className="text-[8px] text-muted-foreground leading-tight">
              Recommendation: Schedule a check-in call to discuss retention strategies.
            </p>
          </div>
